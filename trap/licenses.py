...
# As the simulators generated by TRAP can have any license the simulator
# developer decides on, this file contains some of the most used licenses,
# together with some routines used to manipulate the license string itself.
