    ...
    def executeMemoryQuery(self):
        ...
        if value == 0: #mem-image
            if int(self.lineEdit.text()) >= 0:
                ret_val = os.popen(str(execPath + os.sep + 'mem_analyzer -f ' + self.dump_file + ' -o tempOut.tmp -e ' + self.lineEdit.text() + ' -d 0 -m ' + self.lineEdit_2.text() + ' -w ' + self.lineEdit_6.text() + ' 2>&1'))
            else:
                ret_val = os.popen(str(execPath + os.sep + 'mem_analyzer -f ' + self.dump_file + ' -o tempOut.tmp -d 0 -m ' + self.lineEdit_2.text() + ' -w ' + self.lineEdit_6.text() + ' 2>&1'))
            #print(str('./mem_analyzer -f ' + self.dump_file + ' -o tempOut.tmp -e ' + self.lineEdit.text() + ' -d 0 -m ' + self.lineEdit_2.text() + ' -w ' + self.lineEdit_6.text() + ' 2>&1'))
            if ret_val.readline() != '':
                errorDialog = QtGui.QErrorMessage(self.mainWin)
                errorDialog.showMessage('Error in reading the memory dump: ' + ret_val.readline())
            else:
                self.textEdit.clear()
                try:
            ...
            ret_val = os.popen(str(execPath + os.sep + 'mem_analyzer -f ' + self.dump_file + ' -c ' + self.lineEdit.text() + ' -d 1 -m ' + self.lineEdit_2.text() + ' -w ' + self.lineEdit_6.text() + ' -a ' + self.lineEdit_3.text() + ' 2>&1'))
            print(str(execPath + os.sep + 'mem_analyzer -f ' + self.dump_file + ' -c ' + self.lineEdit.text() + ' -d 1 -m ' + self.lineEdit_2.text() + ' -w ' + self.lineEdit_6.text() + ' 2>&1'))
            if ret_val.readline() == '':
                errorDialog = QtGui.QErrorMessage(self.mainWin)
                errorDialog.showMessage('Error in reading the memory dump: ' + ret_val.readline())
            else:
                self.textEdit.clear()
                try:
                    self.textEdit.setPlainText('\n'.join(ret_val.readlines()))
                except Exception,  e:
                    errorDialog = QtGui.QErrorMessage(self.mainWin)
                    errorDialog.showMessage('Error in reading the memory dump: ' + str(e))
        elif value == 2: #last-modification
            ret_val = os.popen(str(execPath + os.sep + 'mem_analyzer -f ' + self.dump_file + ' -d 2 -m ' + self.lineEdit_2.text() + ' -w ' + self.lineEdit_6.text() + ' -a ' + self.lineEdit_2.text() + ' 2>&1'))
            print(str(execPath + os.sep + 'mem_analyzer -f ' + self.dump_file + ' -d 2 -m ' + self.lineEdit_2.text() + ' -w ' + self.lineEdit_6.text() + ' 2>&1'))
            if ret_val.readline() == '':
                errorDialog = QtGui.QErrorMessage(self.mainWin)
                errorDialog.showMessage('Error in reading the memory dump: ' + ret_val.readline())
            else:
            ...
            ret_val = os.popen(str(execPath + os.sep + 'mem_analyzer -f ' + self.dump_file + ' -o tempOut.tmp -c ' + self.lineEdit.text() + ' -e ' + self.lineEdit_5.text() + ' -d 3 -m ' + self.lineEdit_2.text() + ' -w ' + self.lineEdit_6.text() + ' -a ' + self.lineEdit_3.text() + ' 2>&1'))
            print(str(execPath + os.sep + 'mem_analyzer -f ' + self.dump_file + ' -c ' + self.lineEdit.text() + ' -e ' + self.lineEdit_5.text() + ' -d 3 -m ' + self.lineEdit_2.text() + ' -w ' + self.lineEdit_6.text() + ' 2>&1'))
            if ret_val.readline() != '':
                errorDialog = QtGui.QErrorMessage(self.mainWin)
                errorDialog.showMessage('Error in reading the memory dump: ' + ret_val.readline())
            else:
            ...
            ret_val = os.popen(str(execPath + os.sep + 'mem_analyzer -f ' + self.dump_file + ' -o tempOut.tmp -d 4 -m ' + self.lineEdit_2.text() + ' -w ' + self.lineEdit_6.text() + ' -a ' + self.lineEdit_3.text() + ' 2>&1'))
            print(str(execPath + os.sep + 'mem_analyzer -f ' + self.dump_file + ' -o tempOut.tmp -d 4 -m ' + self.lineEdit_2.text() + ' -w ' + self.lineEdit_6.text() + ' 2>&1'))
            if ret_val.readline() != '':
                errorDialog = QtGui.QErrorMessage(self.mainWin)
                errorDialog.showMessage('Error in reading the memory dump: ' + ret_val.readline())
            else:
            ...
            ret_val = os.popen(str(execPath + os.sep + 'mem_analyzer -f ' + self.dump_file + ' -o tempOut.tmp -d 5 -m ' + self.lineEdit_2.text() + ' -w ' + self.lineEdit_6.text() + ' -v ' + self.lineEdit_4.text() + ' 2>&1'))
            print(str(execPath + os.sep + 'mem_analyzer -f ' + self.dump_file + ' -o tempOut.tmp -d 5 -m ' + self.lineEdit_2.text() + ' -w ' + self.lineEdit_6.text() + ' -v ' + self.lineEdit_4.text() + ' 2>&1'))
            if ret_val.readline() != '':
                errorDialog = QtGui.QErrorMessage(self.mainWin)
                errorDialog.showMessage('Error in reading the memory dump: ' + ret_val.readline())
            else:
